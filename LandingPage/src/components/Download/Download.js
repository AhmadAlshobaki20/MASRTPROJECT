import Download_image from "../../assets/phoneDown.png";
import "./Download.css";
function Download() {
  return (
    <>
      {/* <h1 id="download-caption">Get the app</h1> */}
      <section className="Download">
        <aside>
          <h1 id="Application">Application</h1>
          <h1 id="inner-title">Get Our Mobile Application </h1>
          <p id="about-desc">
          Access the power of education at your
           fingertips! Download our free mobile app for a world of knowledge 
           and convenient learning. Get started today!
          </p>
        ...
        <img className="free-app-imge" src={Download_image} alt=".." />
      </section>
    </>
  );
}
